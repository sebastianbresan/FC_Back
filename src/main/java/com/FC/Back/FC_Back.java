...
public class FC_Back {
    ...
    public static void main(String[] args) {
        ...
        etiquetas1.add(new Etiqueta(null, "JAVASCRIPT"));
        ...
        alumnoRepository.save(new Alumno(4L, "franc@gmail.com", "Franc Touche", "234886655", "Montpellier", "Francia", Presencialidad.MIXTO,false, etiquetas1, u1));
        ...
        alumnoRepository.save(new Alumno(8L, "juanpedro@gmail.com", "Juan Martin Lazaro", "33445523113", "San Pablo", "Brasil", Presencialidad.REMOTO,true, etiquetas1, u2));
    }
}
